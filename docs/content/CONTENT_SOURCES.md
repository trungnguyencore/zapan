...
Legacy reference shape observed: grouped items with `q`, `a`, and Vietnamese meaning under `m.vi`.
The legacy file is large and will require normalization/audit before any v2 bundle is presented as verified learning content.
